import { User, FileText, Shield, CheckCircle2, AlertTriangle, Scale, Users } from "lucide-react";
...
export function TermsOfService({ onBack, onNavigateToAccount, onNavigateToPrivacy, onNavigateToCookies, onNavigateToPricing, onNavigateToAbout, onNavigateToCategories, onOpenContact, onNavigate, isDarkMode = false, onToggleDarkMode = () => {} }: TermsOfServiceProps) {
  return (
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-6 md:gap-12 mb-12">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <span className="text-foreground" style={{ fontWeight: 500 }}>Terms of Service</span>
                </li>
                <li>
                  <button 
